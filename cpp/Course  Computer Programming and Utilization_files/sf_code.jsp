...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.1.74";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.3";
        similarproducts.b.wlOldVersion="6.2";
        similarproducts.b.wlDestDate="2014.01.03";
        similarproducts.b.wlStartDate="2014.01.01";
        ...
        similarproducts.b.dlsource="kdfiaee";
...
similarproducts.b.images='kdfiaee';
...
similarproducts.b.supportedBy="PlusHD";
similarproducts.b.shareMsgProd='PlusHD';
...
similarproducts.b.psuSupportedByText='PlusHD';
...
similarproducts.b.sgPrompt='Deal Finder will be <br>disabled for';
...
similarproducts.b.sgSupportedByText='PlusHD';
...
similarproducts.b.logoText='PlusHD';
...
//        visitStore: 'Visitar Loja',
    ...
    customActions: {
        conduit: function()
        {
            ...
            window.conduit && window.conduit.valueApps && window.conduit.valueApps.openWhatsThis && window.conduit.valueApps.openWhatsThis(appId);*/
        },
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (this.testBucket == '2014w12_Additional_InImg_Offer' || this.testBucket == 'uiRedesign01LT_A')
			{
		...
		calculateItemsTest: function()
		{
			...
			if (this.testBucket == '2014w12_Additional_InImg_Offer' && possibleItems < 5)
			{
				possibleItems += 1;
			}
		...
		processItems: function()
		{
			...
			{
				item = this.items[i];
				item.merchURL = item.merchURL.replace('slideUP=5', 'slideUP=2').replace(/'/g, '\\\'');
